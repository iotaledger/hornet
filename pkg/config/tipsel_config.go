...
const (
	...
	// CfgTipSelSpammerTipsThreshold is the maximum amount of tips in a tip-pool before the spammer tries to reduce these (0 = disable)
...
func init() {
	...
	flag.Int(CfgTipSelNonLazy+CfgTipSelSpammerTipsThreshold, 150, "the maximum amount of tips in a tip-pool (non-lazy) before "+
