...
func (t *Tangle) markBlockAsSolid(cachedBlockMeta *storage.CachedMetadata) {
	...
	t.Events.BlockSolid.Trigger(cachedBlockMeta.Retain()) // meta pass +1
...
func (t *Tangle) solidifyMilestone(newMilestoneIndex iotago.MilestoneIndex, force bool) {
	...
	*/
	...
	t.Events.ConfirmedMilestoneChanged.Trigger(cachedMilestoneToSolidify.Retain()) // milestone pass +1
