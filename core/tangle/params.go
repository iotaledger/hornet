...
type ParametersTangle struct {
	...
	MaxDeltaBlockYoungestConeRootIndexToCMI int `default:"8" usage:"the maximum allowed delta value for the YCRI of a given message in relation to the current CMI before it gets lazy"`
	...
	MaxDeltaBlockOldestConeRootIndexToCMI int `default:"13" usage:"the maximum allowed delta value between OCRI of a given message in relation to the current CMI before it gets semi-lazy"`
