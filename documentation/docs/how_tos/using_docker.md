...
mkdir hornet
cd hornet
curl -L -O "https://github.com/iotaledger/hornet/releases/download/v2.0.0-beta.8/HORNET-2.0.0-beta.8-docker.tar.gz"
tar -zxf HORNET-2.0.0-beta.8-docker.tar.gz
```
