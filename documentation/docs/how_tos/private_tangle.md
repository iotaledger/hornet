...
cd private_tangle
curl -L -O "https://github.com/iotaledger/hornet/releases/download/v2.0.0-beta.9/HORNET-2.0.0-beta.9-private_tangle.tar.gz"
tar -zxf HORNET-2.0.0-beta.9-private_tangle.tar.gz
```
