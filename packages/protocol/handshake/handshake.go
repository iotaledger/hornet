...
const (
	...
	StateInit   HeaderState = 0
	StateFailed HeaderState = 1
	StateOk     HeaderState = 2
)
...
func ParseHandshake(msg []byte) (*Handshake, error) {
	...
	hs := &Handshake{State: StateOk, ServerSocketPort: serverSocketPort, SentTimestamp: sentTimestamp, ByteEncodedCooAddress: byteEncodedCooAddress, MWM: mwm, SupportedVersions: supportedVersions}
	return hs, nil
}
