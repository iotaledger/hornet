...
func computeWhiteFlagMutations(c echo.Context) (*computeWhiteFlagMutationsResponse, error) {
	...
	mutations, err := whiteflag.ComputeWhiteFlagMutations(Plugin.Daemon().ContextStopped(), deps.Storage.UTXOManager(), parentsTraverser, messagesMemcache.CachedMessage, request.Index, parents)
	if err != nil {
