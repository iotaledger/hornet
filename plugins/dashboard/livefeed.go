...
func runLiveFeed() {
	...
	notifyNewTx := events.NewClosure(func(cachedTx *tanglemodel.CachedTransaction, firstSeenLatestMilestoneIndex milestone.Index, latestSolidMilestoneIndex milestone.Index) {
